...
def render_obsidian(on_back=None):
    ...
    st.caption("V8.1 turns LifeOS into a cloud-first GitHub/Obsidian system: LifeOS writes, Obsidian opens the vault wide.")
...
Trackers/
  <tracker-title>--<short-id>.md
    ...
    st.info(
        "V8.1 sync rule: Journals can be pulled back from Obsidian Markdown. Trackers stay one-way from LifeOS to Obsidian because their logic is more structured: deadlines, cycles, fails, history and confirmations."
    )
