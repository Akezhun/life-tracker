...
def sort_tasks(list_):
    return sorted(list_, key=task_sort_key, reverse=True)
...
if view == "Active":
    ...
    with st.form("add"):
        ...
        ttype = st.selectbox("Type", ["deadline", "cycle", "countdown", "gray"])
        ...
        if st.form_submit_button("Add"):
            ...
            log(new_task, "create", {"time": now().isoformat()})
...
if view == "Archive":
    ...
    archived_tasks = sort_tasks(archived_tasks)
